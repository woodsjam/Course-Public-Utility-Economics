...
+ Background on how economists think about allocating costs.  
    ...
    + Sharing costs in a coalition in a way that seems fair, the Shapley Value (1953) 
    + This will look odd
...
+ Look at the individual peak, $\max kW_i$
    ...
    + But, if an individual down the street has a higher peak demand, then you benefit because fewer local outages.
...
+ Two agents, A, B with true benefits of, ${6,10}$. NOTE: We should not sell.

+ A
    + With A, the social value is $6+10 =16$.
    + Without A, you would sell painting for $14, greater than B value of \$10.
    + A is charged $2 = 16 - 14$.
+ B
    + With B, the social value is still $16.
    + Without B, you should sell painting for $14, greater than A value of \$6.
    + B is charged $2 = 16 - 14$.
    
Raises \$4. Not as much as sale, but we keep it.  Both are *pivotal*. Without either, the choice would flip from keeping the painting to not keeping it.


## Clarke Pivot Example 2

+ Do we buy a painting for $14?
+ Two agents, A, B with true benefits of, ${10,12}$.

+ A
    + With A, the social value is $10 + 12 - 14 = 8$.
    + Without A, you don't buy the painting and social value is zero.
    + A is charged $8 = 8 - 0$.
+ B
    + With B, the social value is still $8.
    + Without B, you don't buy the painting.
    + B is charged $8 = 8 - 0$.
    
Raises $16 and you buy the painting for $14.  Both are pivotal, without them, the choice would flip from keeping the painting to not keeping it.


## Clarke Pivot Example 3

+ Do we buy a painting for $7?
+ Three agents, A, B and C with true benefits of, ${1,3,5}$. Buying it is good.

+ A
    + With A, social value is $1+3+5 -7 =2$.
    + Without A, the value of the painting is still $3+5 -7 =1$.
    + A is charged $1 = 2-1$ and we buy painting.
+ B
    + Without B, the other only value painting at $1+5 =6$. No buy
    + B is charged $2 = 2 - 0$. Buy painting.
+ C
    + Without C, the social value of the painting is still less than avoided costs, $7. No Buy
    + C is charged $2.

## Comments
    
 Charges B and C more because they were pivotal. The choice would change if they didn't exist, or had different preferences.
    
Collect only $5 for $7 painting.    

## Clarke Pivot Example 4

+ Do we buy a painting with cost of $14?
+ Three agents, A, B and C with true benefits of, ${9,10,12}$.

+ A
    + Social value is $9+10+12 -14 =17$.
    + Without A, the value of the painting is still $10+12 -14 =8$.
    + A is charged $9.
+ B
    + Without B, the value of the painting is $9+12 -14 =7$.
    + B is charged $10.
+ C
    + Without C, the value of the painting is $9+10 -14=5$.
    + B is charged $12.
    
Raises enough to pay for the painting, $9+10+12 =31$ and everyone pays their personal benefit since they would not change the social choice.  Nobody is pivotal.
...
+ More than one logical volume index, for example a restaurant.
    ...
    + Plates/covers -- Balance between wait staff and food costs.
