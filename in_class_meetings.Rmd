...
We will generally start with our pleasantries and then open up the table read.  The **table read**, a google doc, has been available for a bit. We can decide on when you want them to be available.  It is a 5 or 6 page document that follows the outline of a chapter or paper.  In the document will be elaborations on arguments in the paper, links to external data or resources, proposed worked problems and a few probe questions.
...
+ Zoom hampers some communication.  Only one person can speak at a time unless people are in breakout rooms.  Technically, zoom is great at one-to-many and one-to-one communication but terrible at many-to-many.  We can very easily all type comment and add to google documents.  We can do many-to-many.
...
1.  It is the students' responsibility to create the table read. 
    ...
    1.  You will need to seriously edit.  It is not write, edit, done.  It is write, edit, edit, ..., done.
...
1.  Progress must be made on the table read **within three days** of assignment.
    ...
    1. If no volunteer is found by the end of day four, Jamie will complete the section of the table read and impose an additional Pigouvian penalty of reducing one of the former owner's median table read grade to zero.
