...
+ Will generally hit the true slope parameters but not the intercept
...
+ Intended to be the idea, what can be accomplished.
...
+ Commonly assume a non-normal distribution like the gamma.
