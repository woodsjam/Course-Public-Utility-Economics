...
+ Example:  Maintenance expenditures of $100 a year forever. What is the value of skipping a year?
    + $PW(Maintenance) = \frac{100}{i}$ At i = 10% this is `r 100/.1`.
...
+ Several States of Opportunity Costs
    ...
    + If you face a Peak, Time of Use or Demand Charge.
...
+ Net Neutrality
+ Ocean Hypoxia and Acidification.
+ Small Scale Renewables
+ Small Scale Renewables with tie-in to qualifying facilities.
+ Getting rid of Nuclear.
+ Something about internet access and  competition.
+ Natural Gas and Water Mergers.
+ FERCs Storage bidding
+ Low income F like low income telephone.
+ Cap and Trade General
+ Commercial Buildings


## What About Oregon PUC?

They just finished a forward looking review SB 978 with some items.
...
+ Cap and Trade
    + Banking
    + The collar and how to implement.
    + Adaptive Allowances
    + Offset limitations.
+ Interaction of cap and trade with Renewable Portfolio Standards (RPS)
+ Transportation electrification
+ Methane leakage
+ Community Choice Aggregation
+ Storage
+ Expansion of CAISO
+ Friction in use of the Energy Imbalance Market
+ Natural Gas moving into water for offsets from methane capture.


## FERC

+ Virtual power plants, though not by that name, as well as new definitions so DER can participate at the wholesale level
...
+ New York is on the topic too.  http://documents.dps.ny.gov/public/Common/ViewDoc.aspx?DocRefId={59B620E6-87C4-4C80-8BEC-E15BB6E0545E}
