...
+ Industrial and Residential Annual Load Shapes
+ Peak, Coincident Peak
    + Periodicity of observation, hourly vs 5min, changes the peak
    + Breaking the year up into quarters changes it too.
+ Splitting joint and common by coincident peak share.
+ What Shapely has to say about it.
    + Peak use not just coincident matters.
